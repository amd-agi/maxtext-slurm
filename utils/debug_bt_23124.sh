#!/bin/bash
# Standalone debug script: open 23124's coredump (rank 13, node 097-132) in
...
#
# Submit via:
#   sbatch -N 1 -p amd-rccl -t 01:00:00 -x useocpm2m-097-038,useocpm2m-097-069,useocpm2m-097-084 \
#          -o /home/liyingli/workspace/jax-deepep/maxtext-slurm/outputs/23124-debug-bt/slurm-%j.out \
#          utils/debug_bt_23124.sh
set -e

CORE_DIR=/home/liyingli/workspace/jax-deepep/maxtext-slurm/outputs/23124-JAX-deepseek3-671b-proxy-internode-smoke-4n-full-full-deepep-te-bs2-_env_ONE_GPU_PER_PROCESS_true-_env_PRIMUS_TURBO_JAX_DEEPEP_MODE_per_process-attention_dot_product
CORE_FILE=$(ls "$CORE_DIR"/core.23124.*.useocpm2m-097-132.python3.* 2>/dev/null | head -1)
...
OUT_DIR=/home/liyingli/workspace/jax-deepep/maxtext-slurm/outputs/23124-debug-bt
