...
Two of the 8 assigned k8s nodes (`chi2810`, `chi2872`) had their **routed RoCE GID at sysfs index 2 instead of index 1**, while the other 6 nodes had it at index 1:

```
chi2810: L-G-     (gid[0]=fe80, gid[1]=zero, gid[2]=fd93..., gid[3]=zero)
chi2872: L-G-
chi2766: LG--     (gid[0]=fe80, gid[1]=fd93..., gid[2]=zero)
chi2800: LG--
chi2832: LG--
chi2835: LG--
chi2865: LG--
...
MaxText sets `jax_distributed_heartbeat_timeout_seconds=100` in `base.yml` — much tighter than JAX's 300 s default. On a 1T model, any cold compile >100 s will trip this and get killed. **The `_env_jax_distributed_heartbeat_timeout_seconds=14400` passthrough was applied to every submission after the dense-cf2 pdbs=5 failure** (job 13607). Since the repo doesn't enable persistent JAX compile caching, this hedge is always needed — there is no "warm cache" across jobs on this sweep.
...
RAY=1 ./submit.sh kimi-k2-1t:dense-cf125 \
    ...
    --nodelist=chi2766,chi2800,chi2810,chi2832,chi2835,chi2865,chi2872,chi2883 \
    --time=45:00 -- \
...
**Always include `_env_jax_distributed_heartbeat_timeout_seconds=14400`** — MaxText's 100 s default heartbeat is tighter than most cold compiles on this model. Always use `--time=45:00` unless the cell has been observed to compile in <15 min. See [`moe-pdbs-sweep-prompt.md`](moe-pdbs-sweep-prompt.md) for the retry escalation ladder and disambiguation priority.
